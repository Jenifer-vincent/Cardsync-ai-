...
BUSINESS_CARD_TEMPLATE_NAME = (
    _normalize_env(os.getenv("WHATSAPP_BUSINESS_CARD_TEMPLATE_NAME")) or "cardsync_card_received"
)
...
def build_card_received_template_components(contact: dict[str, Any]) -> list[dict[str, Any]]:
    """Map scanned card fields to cardsync_card_received (7 variables)."""
    ...
    return [
        {
            "type": "body",
            "parameters": [
                {"type": "text", "text": _template_param(first_name, "there")},
                {"type": "text", "text": _template_param(contact_name)},
                {"type": "text", "text": _template_param(extract_company_name(contact))},
                {"type": "text", "text": _template_param(extract_designation(contact))},
                {"type": "text", "text": _template_param(extract_primary_email(contact))},
                {"type": "text", "text": _template_param(extract_website(contact))},
                {"type": "text", "text": _template_param(extract_address(contact))},
            ],
        }
    ]
